...
if __name__ == "__main__":
    ...
    parser.add_argument('--prediction_file', default = '/Users/chenling/Desktop/A2/code_python/pred_trans.txt',
                    help='Path to predictions matrix')
    parser.add_argument('--transcription_file', default = '/Users/chenling/Desktop/A2/data/test_trans.txt',
