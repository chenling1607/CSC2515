...
parser.add_argument('--phone_file', default = '/Users/chenling/Desktop/A2/data/phones.txt', help='Path to phones file')
parser.add_argument('--trans_file', default = '/Users/chenling/Desktop/A2/data/transition_counts.txt', help='Path to transition probabilities')
parser.add_argument('--prediction_file', default = '/Users/chenling/Desktop/A2/code_python/predictions.mat', help='Path to predictions matrix')
parser.add_argument('--output_file', default = '/Users/chenling/Desktop/A2/code_python/pred_trans.txt', help='Output file')
